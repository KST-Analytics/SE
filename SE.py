...
def load():
    SE_PV = pd.read_excel('/content/drive/MyDrive/Invoice2_Deliverables/d_Eastover_iPV_185_240ft_Jul6_Dec28.xlsx', index_col = 0)
    SE_tags = pd.read_excel('/content/drive/MyDrive/Invoice2_Deliverables/d_Eastover_iTAG_185_240ft_Jul6_Dec28.xlsx', index_col = 0)
    SE_hmap = pd.read_excel('/content/drive/MyDrive/Invoice2_Deliverables/d_Eastover_iHMAP_185_240ft_Jul6_Dec28.xlsx', index_col = 0)
